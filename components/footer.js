...
export default function Footer() {
    return (
        <footer className="bg-white p-4">
            <div className="flex items-start justify-between space-x-2 mx-4 md:mx-40 mt-4" style={{ height: "170px" }}>
                <div className="flex flex-col">
                    <div className="flex items-center">
                        <Image src="/logos/alt-logo.svg" alt="Alt Workspaces Logo" width={25} height={25} style={{ cursor: 'pointer' }} />
                        <div className='font-ClashSemiBold text-xl ml-3 mr-10' style={{ letterSpacing: '0.5px' }}> Alt Workspaces </div>
                    </div>
